                      ...
                      std::vector<PointLightSource> *&lightSourceList)
{
    ...
    /* ************************** */
    // (...)
    Material *green_50 = new Phong(Vector3D(0.2, 0.7, 0.3), Vector3D(0.2, 0.6, 0.2), 10);
    Material *red_50 = new Phong(Vector3D(0.7, 0.2, 0.3), Vector3D(0.6, 0.2, 0.2), 10);
    Material *blue_50 = new Phong(Vector3D(0.2, 0.3, 0.7), Vector3D(0.2, 0.2, 0.6), 10);
...
void PaintImage(Film *film)
{
    ...
    for (size_t lin = 0; lin < resY; lin++)
    {
        ...
        for (size_t col = 0; col < resX; col++)
        {
            ...
            double r = (double)col / resX;
            double g = (double)lin / resY;
            double b = 0.0;
